...
public class CountryPickerDialog extends AppCompatDialog implements CountryPickerContainer {
    ...
    public void updateListener(@Nullable UpdateListener updateListener) {
        container.updateListener(updateListener);
    }
    ...
    public static class Builder {
        ...
        @NonNull
        public CountryPickerDialog.Builder setItems(@NonNull List<Country> countries) {
            this.countries = countries;
            return this;
        }

        @NonNull
        public CountryPickerDialog.Builder setFlagShown(boolean shown) {
            this.isFlagShown = shown;
            return this;
        }

        @NonNull
        public CountryPickerDialog.Builder setOnSelectedListener(@Nullable CountryPicker.OnSelectedListener listener) {
