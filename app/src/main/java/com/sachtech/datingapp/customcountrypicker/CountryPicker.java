...
public class CountryPicker extends LinearLayoutCompat {
    ...
    private final CountryPickAdapter adapter;
    // CountryPickerDialog dialog;
    ...
    public CountryPicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        adapter = new CountryPickAdapter(context);
        //dialog = new CountryPickerDialog(context);
        LayoutInflater.from(context).inflate(R.layout.country_picker, this, true);
        update = findViewById(R.id.country_update);
        ...
        update.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                updateListener.onUpdateClick(adapter.getSelectedCountry());
            }
        });
    ...
    @NonNull
    public CountryPickAdapter getAdapter() {
        //noinspection ConstantConditions
        return (CountryPickAdapter) recyclerView.getAdapter();
    }
