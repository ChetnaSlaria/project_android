...
import kotlinx.android.synthetic.main.dialog_verify_remove_user.*

class VerifyRemoveUserDialog :
    KotlinBaseDialogFragment<DialogFragment>(R.layout.dialog_verify_remove_user){
